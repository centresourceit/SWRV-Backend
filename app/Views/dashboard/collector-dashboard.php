            ...
            <div class="card-header" style="margin:0; padding: 0;">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0">Collectorate Dashboard</h3>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Home</a></li>
                                    <li class="breadcrumb-item active">Collectorate Dashboard</li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                            ...
                            <table class="table table-stripped w3-table w3-stripped">
                                ...
                                <tbody>
                                    <tr class="w3-hover-pale-yellow">
                                        ...
                                        <td>
                                            <button class="w3-bar-item w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black w3-tiny" data-toggle="tooltip" title="Action" onclick="$('#actionModal').modal('show');">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content card card-orange card-outline">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <a class="btn btn-success mx-auto text-center" href="<?= base_url(); ?>/customer-dashboard-2">Approve</a>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col w3-col xs-6 sm-6 col-xs-6 col-sm-6">
                                <button class="w3-margin-top w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black btn-block" data-toggle="tooltip" title="Accept" onclick="$('#actionModal').modal('hide');$('#approveModal').modal('show');">
                            ...
                            <div class="col w3-col xs-6 sm-6 col-xs-6 col-sm-6">
                                <a class="w3-margin-top w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black btn-block" data-toggle="tooltip" title="Accept" href="#">
                                    <i class="fa fa-close w3-medium"></i>
                                    &nbsp;&nbsp;Reject
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col w3-col xs-6 sm-6 col-xs-6 col-sm-6">
                                <a class="w3-margin-top w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black btn-block" data-toggle="tooltip" title="Accept" href="#">
                                    <i class="fa fa-calendar w3-medium"></i>
                        ...
                        <div class="row">
                            <div class="w3-hide hide col w3-col xs-6 sm-6 col-xs-6 col-sm-6">
                                <a class="w3-margin-top w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black btn-block" data-toggle="tooltip" title="Accept" href="#">
                            ...
                            <div class="col w3-col xs-6 sm-6 col-xs-6 col-sm-6">
                                <a class="w3-margin-top w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black btn-block" data-toggle="tooltip" title="Accept" href="#">
                                    <i class="fa fa-pie-chart w3-medium"></i>
                                    &nbsp;&nbsp;Delegate to Junior
                                </a>
                            </div>
                        </div>
