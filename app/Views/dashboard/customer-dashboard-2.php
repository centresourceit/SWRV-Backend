                                        ...
                                        <td>
                                            <div class="w3-dropdown-hover">
                                                ...
                                                <div class="w3-dropdown-content w3-bar-block w3-border">
                                                    ...
                                                    <a class="w3-bar-item w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black w3-tiny" data-toggle="tooltip" title="Download Certificate" href="<?= base_url(); ?>/public/dist/img/oc-certificate.jpg" target="_blank" download="certificate.jpg">
                                                        <i class="fa fa-download w3-medium"></i>
