                        ...
                        <div class="table-responsive">
                            <table class="table table-stripped w3-table w3-stripped">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="w3-dropdown-hover">
                                                ...
                                                <div class="w3-dropdown-content w3-bar-block w3-border">
                                                    ...
                                                    <a class="w3-bar-item w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black w3-tiny" data-toggle="tooltip" title="Reply to Raised Query" href="#">
                                                        <i class="far fa-comments w3-medium"></i>
                                                        &nbsp;&nbsp;Reply Query
                                                    </a>
                                                    <a class="w3-bar-item w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black w3-tiny" data-toggle="tooltip" title="Attach Requested Document" href="#">
                                    ...
                                    <?php // foreach ($userdata->getResult() as $row): ?>
                                        <!--<tr class="w3-hover-pale-yellow">
                                            <td><?php // $row->id; ?></td>
                                            <td><?php // $row->name; ?></td>
                                            <td><?php // $row->fatherName; ?></td>
                                            <td><?php // $row->motherName; ?></td>
                                            <td>
                                                <span class="btn btn-flat w3-btn w3-ripple w3-yellow w3-text-black">Submitted</span>
                                            </td>
                                            <td>
