            ...
            <div class="card-header" style="margin:0; padding: 0;">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0">Mamlatdar Dashboard</h3>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Home</a></li>
                                    <li class="breadcrumb-item active">Mamlatdar Dashboard</li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                            ...
                            <table class="table table-stripped w3-table w3-stripped">
                                ...
                                <tbody>
                                    <tr class="w3-hover-pale-yellow">
                                        ...
                                        <td>
                                            <button class="w3-bar-item w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black w3-tiny" data-toggle="tooltip" title="Pay Challan" onclick="$('#actionModal').modal('show');">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content card card-orange card-outline">
                <div class="modal-header">
                    <h3 class="modal-title text-center">Ask Payment</h3>
                ...
                <div class="modal-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                    ...
                    <button type="button" class="btn btn-primary mx-auto text-center" data-dismiss="modal">Add more</button>
                    <hr>
                    <div class="row mt-2">
                        <div class="col-12">
                            <a class="btn btn-success mx-auto text-center" href="<?= base_url(); ?>/customer-dashboard-1">Request to Customer</a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content card card-orange card-outline">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <a class="btn btn-success mx-auto text-center" href="<?= base_url(); ?>/collectorate-dashboard">Approve</a>
                            <button type="button" class="btn btn-danger mx-auto text-center" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col w3-col xs-12 sm-12 col-xs-12 col-sm-12">
                                <button class="w3-margin-top w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black btn-block" data-toggle="tooltip" title="Approve" onclick="$('#actionModal').modal('hide');$('#approveModal').modal('show');">
                        ...
                        <div class="row">
                            <div class="col w3-col xs-6 sm-6 col-xs-6 col-sm-6">
                                <button class="w3-margin-top w3-button btn btn-flat w3-btn w3-ripple w3-indigo w3-text-white w3-hover-orange w3-hover-text-black btn-block" data-toggle="tooltip" title="Request Payment" onclick="$('#actionModal').modal('hide');$('#paymentModal').modal('show');">
