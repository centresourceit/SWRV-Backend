    ...
    <div class="container-fluid">
        <div class="card card-orange card-outline">
            <div class="card-header" style="margin:0; padding: 0;">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0">Land N.A. Permission</h3>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Home</a></li>
                                    <li class="breadcrumb-item active">Land N.A. Permission</li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
            ...
            <div class="card-body">
                ...
                <p style="outline: 0; border: 0; margin: 0; padding: 0; text-align: center; font-weight: 900; font-size: 17px;">FOR GRANT OF PERMISSION FOR N.A. OF LAND</p>
                ...
                <div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;"><u>Subject: Application for grant of permission for N.A. OF LAND</u></div>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <p style="margin: 0; outline: 0; border: 0; padding: 0; text-align: justify;">
                            I hereby apply for grant of permission for <strong>N.A. OF LAND</strong> for which details are given below :-
                        </p>
                    </div>
                </div>
                <?= form_open_multipart(); ?>
...
<!-- /.content -->
<script type="text/javascript" src="<?= base_url(); ?>/public/dist/js/pages/lnd/na-form.js"></script>
