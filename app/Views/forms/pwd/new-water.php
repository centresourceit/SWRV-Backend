    ...
    <div class="container-fluid">
        <div class="card card-orange card-outline">
            <div class="card-header" style="margin:0; padding: 0;">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0">New Water Connection</h3>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
            ...
            <div class="card-body">
                ...
                <div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;"><u>Subject: Application for release of NEW WATER SUPPLY CONNECTION.</u></div>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <p style="margin: 0; outline: 0; border: 0; padding: 0; text-align: justify;">
                            I hereby apply for releasing a new water supply connection for which details are given below :-
                        </p>
                    </div>
                </div>
                <?= form_open_multipart(); ?>
...
<!-- /.content -->
<script type="text/javascript" src="<?= base_url(); ?>/public/dist/js/pages/pwd/new-water-form.js"></script>
