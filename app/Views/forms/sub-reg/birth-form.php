    ...
    <div class="container-fluid">
        <div class="card card-orange card-outline">
            <div class="card-header" style="margin:0; padding: 0;">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0">Birth Registration</h3>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="<?= base_url(); ?>/dashboard">Home</a></li>
                                    <li class="breadcrumb-item active">Birth Registration</li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
            ...
            <div class="card-body">
                ...
                <div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;"><u>Subject: Application for NEW BIRTH REGISTRATION AND CERTIFICATION.</u></div>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <p style="margin: 0; outline: 0; border: 0; padding: 0; text-align: justify;">
                            I hereby apply for birth registration and certification for which details are given below :-
                        </p>
                    </div>
                </div>
                <?= form_open_multipart(); ?>
...
<?php endif; ?>
                            ...
                            <tr class="w3-hover-pale-yellow">
                                ...
                                <td style="text-align: left; min-width: 50%; width: 50%; max-width: 50%;">
                                    <p style="margin: 0; outline: 0; border: 0; padding: 0;">
                                        <label>&nbsp;&nbsp;&nbsp;<input type="radio" name="conectiontype" value="NEW" />&nbsp;&nbsp;NORMAL&nbsp;&nbsp;&nbsp;</label>
                                        <label>&nbsp;&nbsp;&nbsp;<input type="radio" name="conectiontype" value="OLD" />&nbsp;&nbsp;CAESAEREAN&nbsp;&nbsp;&nbsp;</label>
                                        <label>&nbsp;&nbsp;&nbsp;<input type="radio" name="conectiontype" value="RE-CONNECTION" />&nbsp;&nbsp;VACUUM&nbsp;&nbsp;&nbsp;</label>
                                    </p>
                                </td>
                            </tr>
                            <tr class="w3-hover-pale-yellow">
                            ...
                            <tr class="w3-hover-pale-yellow">
                                ...
                                <td style="text-align: left; min-width: 50%; width: 50%; max-width: 50%;">
                                    <p style="margin: 0; outline: 0; border: 0; padding: 0;">
                                        <label>&nbsp;&nbsp;&nbsp;<input type="radio" name="houseowner" value="OWNER" />&nbsp;&nbsp;MALE&nbsp;&nbsp;&nbsp;</label>
                                        <label>&nbsp;&nbsp;&nbsp;<input type="radio" name="houseowner" value="TENANT" />&nbsp;&nbsp;FEMALE&nbsp;&nbsp;&nbsp;</label>
                                    </p>
                                </td>
                            </tr>
                            <tr class="w3-hover-pale-yellow">
                                ...
                                <td style="text-align: left; min-width: 50%; width: 50%; max-width: 50%;">
                                    <p style="margin: 0; outline: 0; border: 0; padding: 0;">
                                        <label>&nbsp;&nbsp;&nbsp;<input type="radio" name="connectioncategory" value="DOMESTIC" />&nbsp;&nbsp;HOSPITAL&nbsp;&nbsp;&nbsp;</label>
                                        <label>&nbsp;&nbsp;&nbsp;<input type="radio" name="connectioncategory" value="NON-DOMESTIC" />&nbsp;&nbsp;HOME&nbsp;&nbsp;&nbsp;</label>
                                    </p>
                                </td>
                            </tr>
                            <tr class="w3-hover-pale-yellow">
                                ...
                                <td style="text-align: left; min-width: 50%; width: 50%; max-width: 50%;">
                                    <p style="margin: 0; outline: 0; border: 0; padding: 0;">
                                        <input type="text" name="diameter" value="<?= set_value('diameter'); ?>" style="min-width: 100%; width: 100%; max-width: 100%;" />
                                    </p>
                                </td>
                            </tr>
                            <tr class="w3-hover-pale-yellow">
...
<!-- /.content -->
<script type="text/javascript" src="<?= base_url(); ?>/public/dist/js/pages/sub-reg/birth-form.js"></script>
